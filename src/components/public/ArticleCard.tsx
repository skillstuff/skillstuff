      ...
      <div className="aspect-[16/9] relative overflow-hidden bg-slate-100 dark:bg-slate-950">
        ...
        <div className="absolute top-3 left-3 flex items-center space-x-2">
          <Link
            ...
            className="px-2.5 py-1 text-[10px] font-extrabold uppercase tracking-wider bg-white/95 text-indigo-700 border border-indigo-100/80 rounded-lg shadow-xs backdrop-blur-md group-hover:bg-indigo-600 group-hover:text-white group-hover:border-indigo-600 transition-all duration-200"
          >
      ...
      <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
        <div className="space-y-2.5">
          <div className="flex items-center space-x-2 text-[11px] font-semibold text-slate-400 dark:text-slate-400">
            <span className="flex items-center text-slate-500 dark:text-slate-400"><Calendar className="w-3 h-3 mr-1 text-indigo-500" />{formatDate(article.publishedAt)}</span>
            <span>&bull;</span>
            <span className="flex items-center text-slate-500 dark:text-slate-400"><Clock className="w-3 h-3 mr-1 text-indigo-500" />{article.readingTime} min read</span>
          </div>

          <h3 className="text-base font-extrabold text-slate-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors line-clamp-2 leading-snug tracking-tight">
        ...
        <div className="flex items-center justify-between pt-3.5 border-t border-slate-100 dark:border-slate-800/80 text-xs">
          <Link href={`/author/${article.author.slug}`} className="flex items-center space-x-2 text-slate-700 dark:text-slate-300 hover:text-indigo-600 transition-colors">
