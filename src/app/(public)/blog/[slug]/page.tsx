    ...
    <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div className="lg:col-span-8 space-y-6">
          ...
          {/* Author Box Footer */}
          <div className="p-6 rounded-2xl bg-gradient-to-br from-brand-50/90 via-white to-sky-50/60 text-slate-900 space-y-3 border border-brand-200/90 shadow-xs dark:from-slate-900 dark:via-slate-900 dark:to-slate-950 dark:text-white dark:border-brand-900/40">
            <div className="flex items-center space-x-3.5">
              <div className="w-12 h-12 rounded-full bg-brand-100 dark:bg-slate-800 font-bold text-base flex items-center justify-center overflow-hidden flex-shrink-0 border border-brand-200 dark:border-slate-700">
                {article.author.avatar ? (
              ...
              <div>
                ...
                <p className="text-xs text-brand-600 dark:text-brand-400 font-semibold">{article.author.title || 'Contributor'}</p>
              </div>
            </div>
            ...
            <Link
              ...
              className="inline-block text-xs font-bold text-brand-600 dark:text-brand-400 hover:underline transition-colors"
            >
